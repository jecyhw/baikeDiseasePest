...
<Collection xmlns:p="http://schemas.microsoft.com/livelabs/pivot/collection/2009" SchemaVersion="1.0" Name="病害数据" xmlns="http://schemas.microsoft.com/collection/metadata/2009">
    ...
    <FacetCategories>
        ...
        <FacetCategory Name="病原类型" Type="String" p:IsFilterVisible="true" p:IsWordWheelVisible="true" p:IsMetaDataVisible="true" />
        ...
        <FacetCategory Name="病原(病原中文名)" Type="String" p:IsFilterVisible="false" p:IsWordWheelVisible="false" p:IsMetaDataVisible="true" />
